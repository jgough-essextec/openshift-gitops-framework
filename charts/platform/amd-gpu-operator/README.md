...
| Parameter   | Description          | Default            |
| ----------- | -------------------- | ------------------ |
| `namespace` | Deployment namespace | `amd-gpu-operator` |
...
kubectl get daemonset -n amd-gpu-operator amd-gpu-device-plugin
kubectl get pods -n amd-gpu-operator -l app.kubernetes.io/name=amd-gpu-device-plugin

# Check node labeller DaemonSet
kubectl get daemonset -n amd-gpu-operator amd-gpu-node-labeller
kubectl get pods -n amd-gpu-operator -l app.kubernetes.io/name=amd-gpu-node-labeller
```
...
```bash
# Device plugin logs
kubectl logs -n amd-gpu-operator -l app.kubernetes.io/name=amd-gpu-device-plugin

# Node labeller logs
kubectl logs -n amd-gpu-operator -l app.kubernetes.io/name=amd-gpu-node-labeller
```
