...
echo ""
echo "⚠️  Note: After scaffolding, you must manually:"
echo "    1. Add the app to ApplicationSet templates in roles/sno/, roles/hub/, roles/test/"
echo "    2. If your app requires CRDs (operators, custom controllers):"
echo "       - Create a 'crds/' directory in the chart root"
echo "       - Place CRD YAML files there (no Helm templating allowed)"
echo "       - CRDs will be installed automatically before other resources"
echo ""
...
echo ""
echo "1. If your app requires CRDs (operators, custom controllers):"
echo "   - Create directory: charts/${CHART_GROUP}/${CHART_NAME}/crds/"
echo "   - Place CRD YAML files there (pure YAML, no Helm templating)"
echo "   - CRDs will be installed automatically before other resources"
echo ""
echo "2. Add this app to ApplicationSet templates in these files:"
