...
```bash
./scripts/reporting/vpa-goldilocks-reporter.py --format json --output vpa-report.json
```

### Generate HTML Report for Specific Namespace

```bash
./scripts/reporting/vpa-goldilocks-reporter.py --format html --output media-vpa-report.html --namespace media
```
...
```bash
./scripts/reporting/vpa-goldilocks-reporter.py --kubeconfig ~/.kube/my-cluster-config --format yaml --output recommendations.yaml
```

### Verbose Output

```bash
./scripts/reporting/vpa-goldilocks-reporter.py --verbose --format console
```
...
./scripts/reporting/vpa-goldilocks-reporter.py --format json --output current-recommendations.json
...
./scripts/reporting/vpa-goldilocks-reporter.py --format html --output "reports/vpa-$(date +%Y%m%d).html"
```
...
./scripts/reporting/vpa-goldilocks-reporter.py --format kubectl --output patches.sh
...
./scripts/reporting/vpa-goldilocks-reporter.py --verbose

# Test specific namespace
./scripts/reporting/vpa-goldilocks-reporter.py --namespace kube-system

# Generate test reports
./scripts/reporting/vpa-goldilocks-reporter.py --format json --output test-report.json
```
